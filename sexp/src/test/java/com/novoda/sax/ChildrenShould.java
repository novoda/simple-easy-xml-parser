...
public class ChildrenShould {
    ...
    public void create_new_child_with_equal_hash_uri_and_local() throws Exception {
        ...
        Element anotherElement = children.getOrCreate(parent, SECOND_STRING_WITH_EQUAL_HASH, SECOND_STRING_WITH_EQUAL_HASH);
    ...
    public void same_child_with_equal_uri_and_local() {
        Element element = children.getOrCreate(parent, FIRST_STRING_WITH_EQUAL_HASH, FIRST_STRING_WITH_EQUAL_HASH);
        Element anotherElement = children.getOrCreate(parent, FIRST_STRING_WITH_EQUAL_HASH, FIRST_STRING_WITH_EQUAL_HASH);
    ...
    public void return_proper_child_with_equal_hash_uri_and_local() {
        ...
        assertThat(children.get(SECOND_STRING_WITH_EQUAL_HASH, SECOND_STRING_WITH_EQUAL_HASH)).isSameAs(anotherElement);
    }
