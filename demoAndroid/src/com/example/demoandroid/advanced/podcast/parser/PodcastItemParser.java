package com.example.demoandroid.advanced.podcast.parser;

import com.example.demoandroid.advanced.podcast.pojo.itunes.ItunesDuration;
import com.example.demoandroid.podcast.pojo.Author;
import com.example.demoandroid.podcast.pojo.Link;
import com.example.demoandroid.podcast.pojo.PodcastItem;
import com.example.demoandroid.podcast.pojo.Title;
...
public class PodcastItemParser implements Parser<PodcastItem> {
	...
	public PodcastItemParser(ElementFinderFactory factory) {
		...
		itunesDurationFinder = factory
				.getStringWrapperTypeFinder(ItunesDuration.class);
		itunesImageFinder = factory.getAttributeFinder(
				new ImageAttributeMarshaller(), TAG_ITUNES_IMAGE_ATTR);
	}
	...
	public void parse(Element element, final ParseWatcher<PodcastItem> listener) {
		...
		itunesDurationFinder.find(element, TAG_ITUNES_NAMESPACE,
				TAG_ITUNES_DURATION);
	...
	private static class ImageAttributeMarshaller implements
			AttributeMarshaller<Link> {
		@Override
