...
public class OneElementInstigator implements Instigator {
	...
	public OneElementInstigator(ElementFinder<String> elementFinder,
			String elementTag, ParseFinishWatcher parseFinishWatcher) {
	...
	@Override
	public void end() {
		// unused in an XML file with only one tag as we need the body of the
		// element
	}
}
