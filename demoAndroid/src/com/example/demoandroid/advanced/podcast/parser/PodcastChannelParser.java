...
public class PodcastChannelParser implements Parser<Channel> {
	...
	public PodcastChannelParser(ElementFinderFactory factory) {
		this.podcastItemFinder = factory.getListElementFinder(
				new PodcastItemParser(factory), parseWatcher);
		...
		this.imageFinder = factory
				.getTypeFinder(new ChannelImageParser(factory));
	}
